...
export const login = createPostApi<ApiTypes.LoginRequestDto, ApiTypes.LoginResponseDto>("auth/login");
...
export const register = createPostApi<ApiTypes.RegisterRequestDto, ApiTypes.RegisterResponseDto>("auth/register");
